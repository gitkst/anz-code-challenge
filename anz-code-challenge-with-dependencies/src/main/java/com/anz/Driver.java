...
public class Driver {
	...
	public static void main(String[] args) {
		...
		int returnCode = callMainDriverProgram(schema, data, tag, output) ;
		
		// Sample Data Files
//		schema = "E:\\workspace4.4\\anz-code-challenge-with-dependencies\\src\\main\\java\\com\\anz\\aus-capitals.json";
//		data = "E:\\workspace4.4\\anz-code-challenge-with-dependencies\\src\\main\\java\\com\\anz\\aus-capitals.csv";
//		tag = "E:\\workspace4.4\\anz-code-challenge-with-dependencies\\src\\main\\java\\com\\anz\\aus-capitals.tag";
//		output = "//path//aus-capitals-output2.csv";
